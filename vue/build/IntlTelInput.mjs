import { mergeModels as N, useModel as x, ref as L, onMounted as M, watch as E, onUnmounted as z, withDirectives as B, openBlock as F, createElementBlock as V, mergeProps as j, vModelText as R } from "vue";
const D = [
  [
    "af",
    // Afghanistan
...
const T = {
  ...
  "888",
  "889"
], v = (u) => u.replace(/\D/g, ""), k = (u = "") => u.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(), S = (u) => {
  const t = v(u);
  if (t.charAt(0) === "1") {
...
class q {
  constructor(t, e = {}) {
    this.id = $++, this.telInput = t, this.highlightedItem = null, this.options = Object.assign({}, T, e), this.hadInitialPlaceholder = !!t.getAttribute("placeholder");
  }
  ...
  _translateCountryNames() {
    for (let t = 0; t < this.countries.length; t++) {
      ...
      this.options.i18n.hasOwnProperty(e) && (this.countries[t].name = this.options.i18n[e], this.options.nativeCountryName && this.options.i18n.hasOwnProperty("countryNativeNames") && this.options.i18n.countryNativeNames.hasOwnProperty(e) && this.countries[t].name != this.options.i18n.countryNativeNames[e] && (this.countries[t].name += " (" + this.options.i18n.countryNativeNames[e] + ")"));
    }
  }
  ...
  _filterCountries(t, e = !1) {
    ...
    for (let n = 0; n < this.countries.length; n++) {
      const o = this.countries[n], r = k(o.name), a = o.name.split(/[^a-zA-ZÀ-ÿа-яА-Я]/).map((d) => d[0]).join("").toLowerCase(), c = `+${o.dialCode}`;
...
const W = (u) => {
  ...
  setup(u, { expose: t, emit: e }) {
    ...
    }), t({ instance: r, input: o }), (h, C) => B((F(), V("input", j({
      ref_key: "input",
      ref: o,
