    ...
    _translateCountryNames() {
      for (let i = 0; i < this.countries.length; i++) {
        ...
        if (this.options.i18n.hasOwnProperty(iso2)) {
          ...
          if (this.options.nativeCountryName && this.options.i18n.hasOwnProperty("countryNativeNames") && this.options.i18n.countryNativeNames.hasOwnProperty(iso2) && this.countries[i].name != this.options.i18n.countryNativeNames[iso2]) {
